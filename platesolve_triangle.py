...
TOL_CENT = np.radians(0.02) # 0.02 degrees in center of frame tolerance
TOL_ROLL = np.radians(0.02) # 0.02 degrees for roll tolerances
log_TOL_SCALE = 0.005       # 1 part in 200 for platescale
...
def load():
    cata_data = np.load('TripleTrianglePlatesolveDatabase/TripleTriangle_pattern_data.npz')
