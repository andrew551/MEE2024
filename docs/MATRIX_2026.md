...
| **what differs from the published 2024 analysis** | same 17 zenith stacks, same dark + flat, same quintic, same corrections. Changed: **centroids windowed + annular on both sides** (2024: moments; the eclipse-side convention is the largest lever, +0.36 ″/mag under moments), **per-frame coronal subtraction and the disk occulter**, **four tiers and all 123 frames** (2024: the 0.4 s block, 109 frames), stage 2 constant + isotropic scale with a two-pass gate (2024: linear free at 2.0 ″), **a 2-D pooled fit** (2024: 1-D radial Δθ = L/R + S·R on one block), 2–10 R☉ (2024: no cut), the close-in star included, a 4-MAD vet, bootstrap/cluster errors and an atmosphere term. Full table in STEP3 §"What differs from the published 2024 analysis" |
| **against the published analysis (Dittrich et al. 2025 §4.4)** | L 1.811 ± 0.084 against **1.839 ± 0.239**; plate scale 1.847368 ± 0.0000055 against **1.847363 ± 0.000013**; L–scale correlation **−0.786 against −0.783**, which is a property of the field geometry both analyses had to find independently. On the *same* 0.4 s block this chain gives ±0.161 against their ±0.239 (corona subtraction, windowed centroids, 2-D fit); pooling the other three blocks gives the rest of the 2.8× |
