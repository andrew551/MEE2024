...
| **atmosphere term: ±0.11 ″** | sixteen consecutive zenith nulls with the cell-2 estimator (Method 2, base): rms ±0.109 ″ at airmass 1.001; × airmass^0.73 at the eclipse's 1.064 → ±0.114, carried ±0.11. (Method 1 on the same nulls: ±0.335 — an imported scale on this instrument, not a cell-2 number) |
| **budget, provisional** | **L = 1.871 ± 0.100 (stat) ± 0.11 (transfer floor) ± 0.03 (model order) ″**, total σ ≈ 0.15, GR at 0.8 σ; **the flat's ±0.2–0.4 ″ stands beside it, unexplained, not folded** |
