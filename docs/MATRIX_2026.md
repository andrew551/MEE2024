...
| **quintic vs septic: settled, septic** | out of sample: the null floor falls 0.126 → 0.105 ″ (−17 %) and every eclipse block's residual falls 1–2 % (pooled 0.198 → 0.193 ″) against a septic seventeen-field reference; L moves +0.03 ″. The quintic was adequate, not sufficient. **Reference of record is septic**; +0.03 ″ carried as model-order sensitivity |
