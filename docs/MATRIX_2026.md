...
| **Station 2: one plate scale for both tiers (2026-09-09)** | Douglas: Method 2 split the tiers (2.50 / 0.55 ″) where Method 1 did not — because each tier's free scale, fitted alone, differs by 96 ± 65 ppm (1.5 σ, noise), worth 1.6 ″ of L at 0.0171 ″/ppm. Pool with ONE scale, as cell 2 does across its four blocks: **L = 1.570 ± 0.672 (stat) ± 0.12 (atm) ″**, ρ −0.86, joint scale 1.8671413 ″/px, 34 observations of 18 stars, no double-star cut. Sharing L alone already brings the tiers' scales to 4.5 ppm apart (−61.2, −56.7); sharing the scale too moves L 0.003 ″. Record set rev05 |
