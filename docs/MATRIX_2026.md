...
| **budget** | **L = 1.804 ± 0.084 (stat) ± 0.11 (atmosphere) ″, total ±0.138**; G ≤ 13, 2–10 R☉, 639 observations of 192 stars, reference gate 0.5 ″. GR at 0.4 σ; **Newton excluded at 6.7 σ; L/L_Newton = 2.06 ± 0.16**; Dittrich et al. 2025's 1.839 ± 0.239 at 0.15 σ; plate scale 1.8473626 ″/px, 0.2 ppm from published. Reported beside it, not folded: the admission rule's 0.05 ″, the model order's 0.03 ″, the reference gate's 0.01–0.02 ″, the coronal blur's 0.01 ″. The flat's ±0.2–0.4 ″ is withdrawn |
