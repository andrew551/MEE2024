...
| **budget** | **L = 1.823 ± 0.096 (stat) ± 0.11 (atmosphere) ″, total ±0.146**; G ≤ 13, 583 observations of 175 stars. GR at 0.5 σ; **Newton excluded at 6.5 σ; L/L_Newton = 2.08 ± 0.17**; Dittrich et al. 2025's 1.839 ± 0.239 at 0.1 σ. Reported beside it, not folded: the admission rule's 0.05 ″ and the model order's 0.03 ″. The flat's ±0.2–0.4 ″ is withdrawn |
| **against the published analysis (Dittrich et al. 2025 §4.4)** | L 1.823 ± 0.095 against **1.839 ± 0.239**; plate scale 1.847369 ± 0.000007 against **1.847363 ± 0.000013**; L–scale correlation −0.818 against **−0.783**. Agreement on all three. On the *same* 0.4 s block this chain gives ±0.169 against their ±0.239 (corona subtraction, windowed centroids, 2-D fit); pooling the other three blocks gives the rest of the 2.5× |
