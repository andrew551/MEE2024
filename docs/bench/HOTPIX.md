...
```bash
python tools/hotpixel_explore.py "I:/MEE test frames/fits/example_with_darks/070424_040415/*.fits" --darks "I:/MEE test frames/fits/example_with_darks/070424_050036 darks 10s/*.fits" --out docs/bench/hotpix
```
```bash
