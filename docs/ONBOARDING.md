...
Expect **931 passed, 26 skipped** on a machine with a star catalogue installed, and
**930 passed, 27 skipped** without one — the extra skip is the offline-provider test, which
...
| [`ROADMAP.md`](ROADMAP.md) | the live plan — measurements, closed fixes, features F1–F31, release order |
