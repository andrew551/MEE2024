...
Expect **885 passed, 26 skipped** on a machine with a star catalogue installed, and
**884 passed, 27 skipped** without one — the extra skip is the offline-provider test, which
