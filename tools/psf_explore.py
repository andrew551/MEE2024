...
Explore the point spread function of real frames.
    ...
    python tools/psf_explore.py "I:/MEE test frames/fits/00_23_49/*.fits" --out docs/bench/psf/zenith --platescale 1.55
    python tools/psf_explore.py "I:/MEE test frames/fits/rasalhague/Rasalhaguemean50.fit" --out docs/bench/psf/rasalhague --platescale 1.65
