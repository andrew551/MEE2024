...
`F:\\MEE_output\\bruns_calibrations\\bruns_rerun`. And the settings are READ from each field's own 2024 results file
...
OUT = r'F:\MEE_output\bruns_calibrations\bruns_rerun'
