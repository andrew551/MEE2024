...
B1 = sorted(glob.glob(r"F:/MEE_output/bruns2017/matrix_bruns2017_atmosphere3/[ELR]C*/**/TWOD_RESIDUALS.csv", recursive=True))
B2 = sorted(glob.glob(r"F:/MEE_output/bruns2017/matrix_bruns2017_atmosphere3/bracket/*/**/TWOD_RESIDUALS.csv", recursive=True))
...
Z = sorted(glob.glob(r"F:/MEE_output/leon2026/step3_record/zenith_nulls/*/**/TWOD_RESIDUALS.csv", recursive=True))
