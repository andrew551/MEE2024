...
| **`FIGURES.md`** | **which script regenerates which figure in `RECORD/refraction/`, with the two flagged for publication and their caption facts** |
...
Reductions land under `F:\MEE_output\refraction\`. Inputs on `G:` and `I:`
are read-only.
