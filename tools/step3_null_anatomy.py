...
rows = []
# ---- Leon zenith
Z = pd.read_csv(r"F:/MEE_output/leon2026/step3_record/zenith_nulls.csv")
for _, r in Z.iterrows():
    ...
    res = glob.glob(rf"F:/MEE_output/leon2026/step3_record/zenith_nulls/{r.field}/**/TWOD_RESIDUALS.csv", recursive=True)[0]
...
B = r"F:/MEE_output/bruns2017/matrix_bruns2017_atmosphere3"
...
T.to_csv(r"F:/MEE_output/leon2026/step3_record/null_vs_scale_step.csv", index=False)
